...
class Bus {
    ...
    public function createNewBus($bus_id, $location, $destination, $departure_time, $arrival_time, $bus_type, $price, $available_seats) {
        try {
            $query = "INSERT INTO {$this->table} 
                      (bus_id, location, destination, departure_time, arrival_time, bus_type, price, available_seats) 
                      VALUES (:bus_id, :location, :destination, :departure_time, :arrival_time, :bus_type, :price, :available_seats)";
    ...
    public function updateBus($id, $location, $destination, $departure_time, $arrival_time, $bus_type, $price, $available_seats) {
        try {
